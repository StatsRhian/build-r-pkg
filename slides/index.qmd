...
1. Add `cli_success("You added two numbers")` to `add()`
...
1. Use `usethis::use_package("cli")` to update `Imports:`
...
- Let me know how you get on 📧 @statRhian
:::

::: {.column}
![](img/hex-RSSConf2025.png){fig-alt="Example hex sticker showing the RSSConf2025 hashtag and and image of Edinburgh Castle" fig-align="right" width=60%}
:::
:::: 
